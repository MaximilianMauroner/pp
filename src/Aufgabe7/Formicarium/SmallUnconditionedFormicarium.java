...
public class SmallUnconditionedFormicarium implements Formicarium {
    private final int price;
    private AntColony antType;

    // Pre: price >= 0
    // Post: constructs a new SmallUnconditionedFormicarium with the given price
    public SmallUnconditionedFormicarium(int price) {
        this.price = price;
    }
    ...
    public Compatability accept(AntColony visitor) {
        return visitor.visitSmallUnconditionedFormicarium(this);
    }
    ...
    public String getType() {
        return "Small Unconditioned Formicarium";
    }
}
