...
//        if (lock.isLocked()) {
//            System.out.println(x + " " + y + " is locked by " + lock + " on thread \t " + Thread.currentThread().getName() + " thread waiting");
//        }
//        lock.lock();
//        locks.get().add(lock);
...
//        lockPosition.get().forEach((point, reentrantLock) -> {
//            System.out.println("Releasing x:" + point.getX() + " y:" + point.getY() + " lock " + reentrantLock + " on thread " + Thread.currentThread().getName());
